...
<div class="row">
    <div class="col s12" style="text-align: center;">
            <img src="/img/rmm.png" class="responsive-img" style="max-height:600px;" />
    </div>
</div>
...
<div class="timeline">
    ...
    <div class="container-timeline right-timeline">
        ...
        <div class="content-timeline">
            <h2>Démarrage du site RealT</h2>
                ...
                <div class="row">
                    <div class="col s12" style="text-align: center;">
                        <img src="/img/RealT-Live.png" class="responsive-img" style="max-height:300px;" />
                        <img src="/img/RealT-Marlowe.png" class="responsive-img" style="max-height:300px;" />
                    </div>
                </div>
        </div>
    </div>
    ...
    <div class="container-timeline left-timeline">
        ...
        <i class="icon fa fa-location-dot"></i>
        <div class="content-timeline">
            <h2>Réserve de maintenance sur un marché de prêt</h2>
            <p>
    ...
    <div class="container-timeline left-timeline">
        ...
        <div class="content-timeline">
            <h2>Incendie</h2>
            <p>Le 28 août 2020, RealT prévient qu'il y a eu un incendie sur l'immeuble Fullerton, sans faire de victime, sur plusieurs unités</p><br/>
            <p>=> Pour plus d'information voir la section <a href="#mon-avis">Mon avis</a></p>
        </div>
    </div>
    <div class="container-timeline right-timeline">
        ...
        <div class="content-timeline">
            ...
            <p>Au environ de février 20201, suite à l'augmentation importantes des frais de transaction sur Ethereum, RealT décide de payer les loyers sur la Gnosis Chain (anciennement xDAI Chain), ainsi que de recevoir ses RealT Tokens sur la Gnosis Chain pour ceux qui le souhaite</p>
        </div>
    </div>
    <div class="container-timeline left-timeline">
        ...
        <div class="content-timeline">
            ...
            <p>RealT mets en place la 1<sup>er</sup> maison de réinvestissement qui permet chaque lundi qu'au lieu de verser un loyer, il achète un RealT Token spécifique
            <br/><br/><b> La 1<sup>er</sup> maison de ce type est 15350 Greydale St, Detroit, MI 48223</b></p>
        </div>
    </div>
    <div class="container-timeline right-timeline">
        ...
        <div class="content-timeline">
            <h2>Assurance</h2>
            <p>RealT fait un partenariat avec <b>Opium Network</b> pour assurer les loyers. Pour des questions de compliance, juste 10700 Whittier Ave, Detroit, MI 48224 fut assuré pendant un certain avant que ce soit repoussé/abandonné</p>
        </div>
    </div>
    <div class="container-timeline left-timeline">
        ...
        <div class="content-timeline">
            ...
            Test de l'ACPI-1 (<b>Auto-Construction of Initial Price</b>) qui devait permettre de déterminer le prix de lancement du REG avec 4 ACPI - abandonnée par la suite pour des raisons de compliance<br/><br/>
                <div class="row">
                    <div class="col s12" style="text-align: center;">
                            <img src="/img/ACPI-1.jpeg" class="responsive-img" style="max-height:600px;" />
                    </div>
                </div>            
            </li>
    ...
    <div class="container-timeline left-timeline">
        ...
        <div class="content-timeline">
            ...
            <p>
                ...
                <div class="row">
                    <div class="col s12" style="text-align: center;">
                            <img src="/img/rmm_V1.png" class="responsive-img" style="max-height:600px;" />
                    </div>
                </div>         
            </p>
        </div>
        ...
        <div class="content-timeline">
            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="row">
                        <div class="col s12" style="text-align: center;">
                                <img src="/img/Roofstock.png" class="responsive-img" style="max-height:600px;" />
                        </div>
                    </div>   
                </li>
            </ul>
    ...
    <div class="container-timeline left-timeline">
        ...
        <div class="content-timeline">
            <h2>Equity</h2>
            <p>
                Le 21 mars 2024, RealT ouvre son capital
            </p>
        </div>
    </div>
</div>
