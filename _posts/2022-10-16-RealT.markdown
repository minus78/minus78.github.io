...
<div class="timeline">
    ...
    <div class="container-timeline right-timeline">
        ...
        <div class="content-timeline">
            <h2>Incendie</h2>
            Il y a un incendie qui détruit complètement la propriété <b>581-587 Jefferson Ave, Rochester, NY 14611</b>, le 17 janvier 2024. Jefferson avant l'incendie:
            <br/><br/>
            <div class="row">
                <div class="col s12" style="text-align: center;">
    ...
    <div class="container-timeline left-timeline">
        ...
        <div class="content-timeline">
            <h2>Equity</h2>
            Le 21 mars 2024, RealT ouvre son capital. 5 000 000$ de token sont vendu qui correspondent à 6,42% de la société RealT Inc.
            Les acheteurs du token sont actionnaires via une société Suisse monté pour l'occasion.
        </div>
    </div>
</div>
