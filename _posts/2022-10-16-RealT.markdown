...
<div class="timeline">
    ...
    <div class="container-timeline right-timeline">
        ...
        <div class="content-timeline">
            ...
            <p>Au environ de février 2021, suite à l'augmentation importantes des frais de transaction sur Ethereum, RealT décide de payer les loyers sur la Gnosis Chain (anciennement xDAI Chain), ainsi que de recevoir ses RealT Tokens sur la Gnosis Chain pour ceux qui le souhaite</p>
        </div>
    </div>
    <div class="container-timeline left-timeline">
