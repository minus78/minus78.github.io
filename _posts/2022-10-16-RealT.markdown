...
<b>
    <i class="icon fa fa-triangle-exclamation"></i>
        Attention RealT est en procès contre la ville de Détroit, il y a une action collective en cours contre RealT ici: https://delomel-avocat.com/rejoindre-une-action/action-collective-real-t/. Je déconseille d'investir dans RealT!
</b>
</span>
